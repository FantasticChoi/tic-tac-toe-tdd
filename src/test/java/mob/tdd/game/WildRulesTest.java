...
public class WildRulesTest {
    ...
    public void shouldReturnOTurnAsNextState() throws Exception {
        ...
        Assertions.assertThat(gameState).isEqualTo(GameState.O_TURN);
    }
    ...
    public void shouldReturnXTurnAsNextState() throws Exception {
        ...
        Assertions.assertThat(gameState).isEqualTo(GameState.X_TURN);
    }

    @Test
    public void shouldDetectDrawGame() throws Exception {
